  ...
  return (
    <div className='min-h-screen font-sans bg-black text-white'>
      <nav className='sticky top-0 z-20 bg-black/90 backdrop-blur border-b border-yellow-500/20 px-6 py-4 flex justify-between items-center'>
        <button onClick={() => setPage('home')} className='flex items-center gap-3 text-2xl font-bold text-yellow-400'><img src='https://kommodo.ai/i/rOjpVcKC9rFmXFlCuWxE' alt='Sulcru Organic Logo' className='w-10 h-10 object-contain' /><span>Sulcru Organic</span></button>
      ...
      {page === 'home' && (
        <main className='p-10 space-y-10 bg-[radial-gradient(circle_at_top_right,rgba(255,215,0,0.12),transparent_35%),radial-gradient(circle_at_bottom_left,rgba(255,215,0,0.08),transparent_30%)]'>
          <section className='grid md:grid-cols-2 gap-8 items-center'>
            <div className='text-center md:text-left'><img src='https://kommodo.ai/i/rOjpVcKC9rFmXFlCuWxE' alt='Sulcru Organic Logo' className='w-32 h-32 object-contain mx-auto md:mx-0 mb-6 drop-shadow-2xl' /><h1 className='text-6xl font-bold text-yellow-400 mb-4'>Sulcru Organic</h1>
